...
case class CallResponse[Payload](seqId: SequenceId, result: Payload)         extends ServerMessage[Payload, Nothing, Nothing]
case class CallResponseFailure[Failure](seqId: SequenceId, failure: Failure) extends ServerMessage[Nothing, Nothing, Failure]
